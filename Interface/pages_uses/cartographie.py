...
#@st.cache_data
def load_data():
    os.chdir('D:/M2UNIVLYON2/python_project/Performance_Energetique/Data')
    # Charger les jeux de données
    logements_existants = pd.read_csv("dpe-v2-logements-existants.csv")
    logements_neufs = pd.read_csv("dpe-v2-logements-neufs.csv")
    adresses = pd.read_csv("adresses-69.csv", sep=";")
